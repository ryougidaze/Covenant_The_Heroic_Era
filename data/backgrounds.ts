...
export const backgrounds: Background[] = [
  {
    ...
    color: "covenant-gold",
    textColor: "text-covenant-gold",
    borderColor: "border-covenant-gold/40",
    bgColor: "bg-covenant-dark",
