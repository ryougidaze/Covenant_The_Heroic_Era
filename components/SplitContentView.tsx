...
export default function SplitContentView({ title, subtitle, sections }: SplitContentViewProps) {
  ...
  return (
    <div className="flex flex-col md:flex-row md:gap-0">
      ...
      {/* Right content */}
      <div className="flex-1 px-4 pb-20 pt-6 md:w-3/4 md:pl-8 md:pr-20 lg:pr-28 md:pt-0">
        ...
        <div className="mt-8 space-y-16 md:mt-12 md:space-y-20">
          {sections.map((section) => (
            <section key={section.id} id={section.id}>
              <h2 className="font-heading text-lg font-semibold tracking-[0.12em] text-covenant-gold md:text-xl">{section.title}</h2>
